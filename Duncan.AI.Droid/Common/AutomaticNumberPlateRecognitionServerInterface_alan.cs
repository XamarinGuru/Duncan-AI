   ...
   public static interface Orientation {
       ...
       public static final short RIGHT_BOTTOM = 8;
        ...
        private async Task<bool> FetchANPRUsingRestSharp(string path)
        {
            ...
            //string loImageContentType = "Image-type: jpg";
            ...
            int loServerPort = TTRegistry.glRegistry.GetRegistryValueAsInt(TTRegistry.regSECTION_ISSUE_AP,
            ...
            byte[] documentBytes = ImageToByteArrayForANPRResaved(path, newWidth, newHeight);
