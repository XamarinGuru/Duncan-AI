...
namespace Duncan.AI.Droid.Common
{
    class AutomaticNumberPlateRecognitionServerInterface
    {
        ...
        public class RootObject
        {
            ...
            public List<Duncan.AI.Droid.Common.AutomaticNumberPlateRecognitionServerInterface.Result> results { get; set; }
        }
   ...
   public static interface Orientation {
       ...
       public static final short RIGHT_BOTTOM = 8;
        ...
        private async Task<bool> FetchANPRUsingRestSharp(string path)
        {
            ...
            _asyncHandle = restClient.ExecuteAsync<Duncan.AI.Droid.Common.AutomaticNumberPlateRecognitionServerInterface.RootObject>(request, (response) =>
            {
                ...
                if (response.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    try
                    {
                        ...
                        RootObject myLPRResults = deserial.Deserialize<RootObject>(response);


                        foreach (Result oneResult in myLPRResults.results)
                        {
                            topPlateResult = oneResult.plate;
                            topPlateConfidence = oneResult.confidence;


                            foreach (Candidate oneCandidate in oneResult.candidates)
                            {
                            ...
                            // we are only going to look at the 1st result....
                            break;
                        }
