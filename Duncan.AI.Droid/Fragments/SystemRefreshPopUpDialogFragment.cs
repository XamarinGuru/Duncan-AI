...
{
	public class SystemRefreshPopUpDialogFragment : DialogFragment
	{
        ...
        SystemRefreshPopUpDialogTimer fCountdownTimer = null;
        ...
        int cnMarginCommentLabelLeft = 20;
        int cnMarginCommentLabelTop = 20;
        int cnMarginCommentLabelRight = 20;
        int cnMarginCommentLabelBottom = 35;
        ...
        public override Android.App.Dialog OnCreateDialog(Bundle savedInstanceState)
        {
            ...
            _tagName = "menu_popup"; // get from parameters if really needed // Helper.BuildSystemRefreshPopUpDialogFragmentTag(_structName);
            ...
            _dialogView = Activity.LayoutInflater.Inflate(Resource.Layout.SystemRefreshPopUpDialogFragment, null);
            ...
            _statustext = _dialogView.FindViewById<TextView>(Resource.Id.status);
            if (_statustext != null)
            {
                _statustext.Text = "";
                _statustext.Gravity = (GravityFlags.CenterHorizontal | GravityFlags.CenterVertical);

                // initialize our typeface 
                loCustomTypeface = FontManager.GetTypeface(DroidContext.ApplicationContext, FontManager.cnCardViewCounterTextSmallTypeface);
                if (loCustomTypeface != null)
                {
                    _statustext.Typeface = loCustomTypeface;
                }
                _statustext.SetTextSize(Android.Util.ComplexUnitType.Sp, FontManager.cnCardViewCounterTextSmallTypefaceSizeSp);
            }
            ...
            //_userCommentLabel.Gravity = (GravityFlags.CenterHorizontal | GravityFlags.CenterVertical);
            ...
            // no, you cant cancel    builder.SetNegativeButton("CANCEL", btnCancel_Click);
        ...
        private void CustomizeUserCommentDialogButtons()
        {
            ...
            if (btnConfirm != null)
            {
                ...
                btnConfirm.Text = "OK";// Constants.cnMenuPopup_ExitText;
        ...
        async void btnOKClick(object sender, EventArgs e)
        {
            ...
            MemoryWatcher.RestartApplication(_context);
        ...
        internal void SetRebootParams(Android.App.Activity iActivity, Context context)
        {
            _Activity = iActivity;
            _context = context;
        }
        ...
        public void UpdateDialogCountDownDisplay( int iSecondsRemaining )
        {

            if (_statustext != null)
            {
                _statustext.Text = iSecondsRemaining.ToString();
            }
        ...
        public override void OnStart()
        {
            ...
            fCountdownTimer = new SystemRefreshPopUpDialogTimer(this);
            fCountdownTimer.Run();

        }


    }  // end class SystemRefreshPopUpDialogFragment



    class SystemRefreshPopUpDialogTimer : Java.Lang.Object, IRunnable
    {

        private readonly SystemRefreshPopUpDialogFragment _Owner;
        private readonly Handler _Handler = new Handler();


        private int SecondsCountDownToExpiration = 10;


        public SystemRefreshPopUpDialogTimer(SystemRefreshPopUpDialogFragment iOwnerDialog)
        {
            _Owner = iOwnerDialog;
        }
        public void Run()
        {
            if (_Owner != null)
            {
                _Owner.UpdateDialogCountDownDisplay(SecondsCountDownToExpiration);
            }

            _Handler.PostDelayed(UpdateTimer, 1000);
        }
        ...
        private async void UpdateTimer()
        {
            if (_Owner != null)
            {
                SecondsCountDownToExpiration--;

                _Owner.UpdateDialogCountDownDisplay(SecondsCountDownToExpiration);

                if (SecondsCountDownToExpiration > 0)
                {
                    _Handler.PostDelayed(UpdateTimer, 1000);
                }
            }
